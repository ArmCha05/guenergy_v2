...
<script>
	...
	[
		...
		{"Nombre":"Vertimania Sucursal Guadalajara", "Direccion": "Av. de la Paz 2350, Lafayette, 44160", "Telefono": "33 36165371", "Website": "http://www.vertimania.com", "Latitud":20.672427, "Longitud":-103.375085,"Linea":"Toda"},
		...
		{"Nombre":"Garnier Sports", "Direccion": "CARRETERA TORREON SAN PEDRO K.M 3.3 S/N LOCAL 3, Col. LA UNION C.P. 27367, TORREON, COAHUILA, MEXICO", "Telefono": "(871) 2 04 41 90", "Website": "www.facebook.com/garniersports/", "Latitud":25.546374,"Longitud":-103.450306,"Linea":"Toda"},
		{"Nombre":"Garnier Sports", "Direccion": "Blvrd Independencia 94-A, Los Ángeles, 27000 Torreón, ", "Telefono": "(871) 7 12 60 03", "Website": " www.facebook.com/garniersports/", "Latitud":25.549171,"Longitud":-103.446835,"Linea":""},
		{"Nombre":"Fitness Market ", "Direccion": " Av. Convención sur #1301-C Jardines de La Luz CP 20296 Aguascalientes, Ags.", "Telefono": " 449 187 87 74", "Website": "www.fitnessmarket.mx  ", "Latitud":21.866073,"Longitud":-102.284267,"Linea":""},
		{"Nombre":"CICLOPARTES2000", "Direccion": "Av. Rio San Pedro Sur No.1 Col Centro. ", "Telefono": "639 4742617", "Website": "www.facebook.com/CICLOPARTES2000/", "Latitud":28.184708,"Longitud":-105.473678,"Linea":"Si"},
		...
		{"Nombre":"ENERLIFE", "Direccion": "Av. Lopez Portillo S/N, entre tercera privada y calle 18, Col. Samula C.P. 24090 Campeche Campeche.", "Telefono": "(981) 1446360 y (981) 1446361", "Website": "es-la.facebook.com/Enerlife-Campeche-909169165802870/", "Latitud":19.825344,"Longitud":-90.544910,"Linea":""},
		{"Nombre":"SWIM BIKE & RUN (SBR)", "Direccion": "PLAZA DIAMANTE, AV. VASCO DE QUIROGA 3900, LOMAS DE SANTA FE, CUAJIMALPA", "Telefono": " 5292*3594 Y 1664*6309", "Website": " www.sbr-mexico.com ", "Latitud":19.360937,"Longitud":-99.278783,"Linea":""},
		{"Nombre":"Puk Travel Sports ", "Direccion": "Luis González Obregon 10, Zona centro. Entre Presidencia y Jardín Unión Frente à Banorte ", "Telefono": "01 4737321999", "Website": "www.facebook.com/PukTravel/", "Latitud":19.436821,"Longitud":-99.133119,"Linea":""},
		...
		{"Nombre":"WOWBIKE", "Direccion": "CALZADA AL SUMIDERO N°72-A, COL. LAS DELICIAS TUXTLA GUTIERREZ, CHIAPAS", "Telefono": "WHATSAPP: 9612367737", "Website": "es-la.facebook.com/WOW-BIKES-242547815938668/", "Latitud":16.762536,"Longitud":-93.104830,"Linea":""},
		...
		{"Nombre":"EL SALON DE LA BICICLETA ", "Direccion": "JUAREZ 872, COL. CENTRO", "Telefono": "33 38 26 15 07", "Website": "www.facebook.com", "Latitud":20.674968,"Longitud":-103.357798,"Linea":""},
		...
		{"Nombre":"TRANSVISION BIKE INTERLOMAS", "Direccion": " BLVD. INTERLOMAS NO. 5 SUBANCLA 4 HUIXQUILUCAN EDO. DE MEXICO", "Telefono": "5536050717", "Website": "www.transvisionbike.com ", "Latitud":19.398904,"Longitud":-99.288528,"Linea":""},
	...
	function initMap() {
	  ...
	  for(var i = 0; i<sucursales.length;i++)
	  {
		  ...
		  var $tr = $('<tr><td><h6></h6><hr><h7></h7><br><h7></h7><br><h7></h7><br><a></a><br></td></tr>');
		  $tr.attr('id',i);
		  $tr.find('h6').text(sucursales[i]['Nombre']);
		  $tr.find('h7').eq(0).text(sucursales[i]['Direccion']);
		  $tr.find('h7').eq(1).text(sucursales[i]['Telefono']);
		  $tr.find('a').eq(0).text(sucursales[i]['Website']);
		  $tr.find('a').eq(0).attr('href',sucursales[i]['Website']);
		  $tr.find('h7').eq(2).text(sucursales[i]['Linea']);
	...
	function cambiarMapa(indice)
	{
		...
		map.setZoom(15);
     	...
     	'<div id="siteNotice">'+
      	...
      	'<a href="http://'+sucursales[indice]['Website']+'">'+sucursales[indice]['Website']+'</a href=""><br>'+

...
<link rel="stylesheet" id='application-css' type="text/css" href="catalog/view/theme/default/stylesheet/bootstrap.min.css" media="all">
...
<div class="container">
  ...
  <div class="row">
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-collapse active" id="collapse-payment-address">
            <div class="panel-body"></div>
          </div>
        </div>
        <?php } else { ?>
    ...
    <a href="index.php?route=checkout/cart">
        <button class="btn btn-danger">Regresar al carrito</button>
    </a>
</div>
...
$(document).ready(function() {
    $.ajax({
        ...
        success: function(html) {
            ...
            $('#collapse-payment-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_option; ?> <i class="fa fa-caret-down"></i></a>');
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    dataType: 'html',
                    success: function(html) {
                       $('.panel-collapse.active').removeClass('active').addClass('collapse');
                       $('#collapse-shipping-address').removeClass('collapse').addClass('active');
